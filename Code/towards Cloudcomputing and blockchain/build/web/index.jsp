      ...
      <div class="container-fluid px-0">
      	<div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-start">
	        ...
	        <div class="one-forth d-flex align-items-center ftco-animate js-fullheight">
	        	<div class="text mt-5">
	        		<span class="subheading">Cloud Computing</span>
	            <h1 class="mb-3"><span>Blockchain and </span> <span>Integrated </span> <span>Applications</span></h1>
	            <p>Cloud Computing is a technology widely used in academia and industry, providing varied services on demand.</p>
