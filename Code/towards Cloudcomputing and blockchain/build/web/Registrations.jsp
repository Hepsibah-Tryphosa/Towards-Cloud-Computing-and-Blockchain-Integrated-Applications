            ...
            <div class="container-fluid px-0">
                <div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-start">
                    ...
                    <div class="one-forth d-flex align-items-center ftco-animate js-fullheight">
                        <div class="text mt-5">
                            <span class="subheading">User Register Form</span>
                            <p>
                            <form action="./UserRegisterActions" method="POST" class="table-responsive" style="width:100%">
                                <table>
                                    ...
                                    <tr>
                                        <td></td><td></td>
                                        <td><button type="submit" value="Register" class="btn btn-secondary px-4 py-3">Register</button></td>
                                    </tr>
                                    <tr>
                                        <td>
