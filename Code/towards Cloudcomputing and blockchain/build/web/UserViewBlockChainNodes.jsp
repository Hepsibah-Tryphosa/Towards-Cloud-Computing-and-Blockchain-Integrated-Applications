<%@page import="com.cbchain.utility.GetDateFormat"%>
            ...
            <div class="container pb-md-5">
                <div class="row justify-content-center mb-5">
                    <div class="col-md-8 text-center heading-section heading-section-white ftco-animate">
                        <h2 class="mb-3">View Blockchain Node Details </h2>
                    </div>
                </div>
                            ...
                            <table border="2px" class="table table-hover table-dark">
                                ...
                                <tbody>
                                    ...
                                    try(Connection con = DBConnection.getDBConnection()){
                                        String sqlQuery = "select *from blockchain where loginuser = ?";
                                        ...
                                        count++;
                                        int id = rs.getInt("id");
                                        long millis = rs.getLong("trnstimestamp");
                                        String date = GetDateFormat.getLongToDate(millis);
                                        
                                        %>
                                     <tr scope="row" style="color: BLUE; background-color:#FFFCBB">
                                        <td><%=count%></td>
                                        <td><%=rs.getString("currenthash")%></td>
                                        <td><%=rs.getString("previoushash")%></td>
